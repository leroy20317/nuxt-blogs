  ...
  >
    ...
    <div :style="'position:relative;overflow:hidden;width:' + dataWidth + 'px;'">
      <div :style="'position:relative;width:' + dataWidth + 'px;height:' + dataHeight + 'px;'">
        ...
        />
        <canvas id="puzzle-box" ref="puzzleBox" :height="dataHeight" :width="dataWidth"></canvas>
      </div>
      <div
      ...
      >
        <canvas
          ...
          :width="dataWidth"
        ></canvas>
        <canvas id="puzzle-lost" ref="puzzleLost" :height="dataHeight" :width="dataWidth"></canvas>
      </div>
      <p ref="verTips" :class="'ver-tips' + (displayTips ? ' slider-tips' : '')">
        <template v-if="verification">
          <span class="iconfont icon-success" style="color: #42ca6b"></span>
    ...
    <div :style="'width:' + dataWidth + 'px;'" class="slider-container">
...
export default {
  ...
  props: {
    ...
    puzzleImgList: {
      type: Array,
      default: () => [
        'https://static.leroy.net.cn/uploads/image/1610074537705.png',
        'https://static.leroy.net.cn/uploads/image/1609830048776.jpg',
        'https://static.leroy.net.cn/uploads/image/1610074537705.png'
      ]
    },
    // 滑块的大小
  ...
  created() {
    // 随机显示一张图片
    const imgRandomIndex = Math.round(Math.random() * (this.puzzleImgList.length - 1));
  ...
  methods: {
    ...
    moveEnd(e) {
      ...
      const deviationValue = this.deviationValue;
