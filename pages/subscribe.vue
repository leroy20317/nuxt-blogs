    ...
    <div class="content" :style="`background: url(${staticHost}image/other/subscribe.png) no-repeat bottom right`">
      ...
      <div class="main">
        ...
        <template v-else>
          ...
          <button type="submit" @click="submit">
            {{ count ? `${count}s后可重发` : 'subscribe' }}
          </button>
          <span :class="hint ? 'show' : ''" class="hint">{{ text }}</span>
        </template>
      </div>
      <div class="waves-area">
        ...
        >
          ...
          <g class="parallax">
            <use x="48" xlink:href="#gentle-wave" y="0" />
            <use x="48" xlink:href="#gentle-wave" y="3" />
            <use x="48" xlink:href="#gentle-wave" y="5" />
            <use x="48" xlink:href="#gentle-wave" y="7" />
          </g>
        </svg>
      </div>
    </div>
